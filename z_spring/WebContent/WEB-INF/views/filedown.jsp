...
<%@ page import="com.crud.dto.FileUpDTO"%>
...
//파일이 저장될 경로.
String realPath =  "C:/stu_2020.02.12_KSJ/z_spring";

//String realPath =  "C:/stu_2020.02.12_KSJ/z_spring/WebContent/WEB-INF/resources/imagecollection/";
 
if(request.getAttribute("emp_pic")== null || "".equals(request.getAttribute("emp_pic"))){
	//out.println("<script language='javascript'>alert('FileUpDTO.getEmp_pic()')</script>");
    ...
    // 파라미터로 받은 파일 이름.
    String requestFileNameAndPath = "다운로드";
